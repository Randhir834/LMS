...
interface InstructorAuthSplitShellProps {
  leftTitle: ReactNode;
  leftSubtitle: string;
  centered?: boolean;
  children: ReactNode;
...
export default function InstructorAuthSplitShell({ leftTitle, leftSubtitle, centered = true, children }: InstructorAuthSplitShellProps) {
  return (
    <div className="min-h-screen flex flex-col md:flex-row md:h-screen md:overflow-hidden">
      ...
      <div
        className="relative w-full md:w-[55%] hidden md:flex flex-col justify-between p-6 sm:p-8 md:p-12 lg:p-16 overflow-hidden bg-cover bg-center bg-no-repeat bg-emerald-950"
        style={{ backgroundImage: 'url("/images/logininstructureimage.png")' }}
      >
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5 sm:gap-3 mb-6 sm:mb-8 max-w-lg">
            <div className="flex items-center gap-2 sm:gap-2.5 bg-white/90 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2 sm:py-2.5 shadow-lg w-full min-h-[44px] sm:min-h-[52px] h-[44px] sm:h-[52px] box-border">
              ...
              <span className="min-w-0 text-xs font-medium text-text-primary text-left leading-snug line-clamp-2">Create &amp; Manage Courses</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-2.5 bg-white/90 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2 sm:py-2.5 shadow-lg w-full min-h-[44px] sm:min-h-[52px] h-[44px] sm:h-[52px] box-border">
              ...
              <span className="min-w-0 text-xs font-medium text-text-primary text-left leading-snug line-clamp-2">Track Student Progress</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-2.5 bg-white/90 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2 sm:py-2.5 shadow-lg w-full min-h-[44px] sm:min-h-[52px] h-[44px] sm:h-[52px] box-border">
              ...
              <span className="min-w-0 text-xs font-medium text-text-primary text-left leading-snug line-clamp-2">Schedule Live Classes</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-2.5 bg-white/90 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2 sm:py-2.5 shadow-lg w-full min-h-[44px] sm:min-h-[52px] h-[44px] sm:h-[52px] box-border">
              ...
              <span className="min-w-0 text-xs font-medium text-text-primary text-left leading-snug line-clamp-2">Upload Study Materials</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-2.5 bg-white/90 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2 sm:py-2.5 shadow-lg w-full min-h-[44px] sm:min-h-[52px] h-[44px] sm:h-[52px] box-border">
              <div className="w-6 h-6 sm:w-8 sm:h-8 shrink-0 rounded-lg bg-emerald-50 flex items-center justify-center">
                <svg width="12" height="12" className="sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
              </div>
              <span className="min-w-0 text-xs font-medium text-text-primary text-left leading-snug line-clamp-2">View Earnings &amp; Reports</span>
            </div>
          </div>
        </div>
      </div>
