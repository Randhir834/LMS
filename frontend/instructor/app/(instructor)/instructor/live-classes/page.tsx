...
function InstructorLiveClassesContent() {
  ...
  const filteredClasses = classes.filter(c => {
    ...
    if (filter === 'upcoming') return scheduledDate > now;
    if (filter === 'completed') return scheduledDate <= now;
    return true;
  });
  ...
  return (
    <div className="p-4 md:p-8 max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-[#1E293B]">Live Classes</h1>
          ...
          <CardContent>
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-[#1E293B] mb-2">
                {classes.length === 0 ? 'No live classes scheduled' : 'No classes in this category'}
              </h3>
