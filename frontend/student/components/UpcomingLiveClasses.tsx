      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            <Calendar className="size-10 text-[#CBD5E1] mx-auto mb-3" />
            ...
            return (
              <div
                ...
                className={`p-4 border rounded-lg transition-all ${
                  isStartingSoon
                    ? 'border-[#1B8A44] bg-[#F0FDF4]'
                    : 'border-[#E2E8F0] hover:border-[#1B8A44]'
                }`}
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex flex-col items-end gap-2 flex-shrink-0">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-[#1B8A44] hover:text-[#157a35] transition-colors"
                    >
