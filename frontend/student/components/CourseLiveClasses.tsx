      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            <Calendar className="size-12 text-[#CBD5E1] mx-auto mb-3" />
            <p className="text-sm text-[#64748B]">No upcoming live classes scheduled</p>
            <p className="text-xs text-[#64748B] mt-1">Check back soon for new classes</p>
          </div>
        </CardContent>
      </Card>
    );
            ...
            <div
              ...
              className={`p-4 border rounded-lg transition-all ${
                isStartingSoon(liveClass.scheduled_at)
                  ...
                  : 'border-[#E2E8F0] hover:border-[#1B8A44]/20'
              }`}
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h4 className="font-semibold text-[#1E293B]">{liveClass.title}</h4>
                    {isStartingSoon(liveClass.scheduled_at) && (
                      <span className="px-2 py-1 text-xs font-medium bg-[#DC2626] text-white rounded-full">
                        Starting Soon
                      </span>
                    )}
                  </div>
                  ...
                  {liveClass.description && (
                    <p className="text-sm text-[#64748B] mb-3 line-clamp-2">{liveClass.description}</p>
                  )}
                  ...
                  <div className="mt-3 text-sm font-medium text-[#1B8A44]">
